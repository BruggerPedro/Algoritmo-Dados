...
Lista l; Lista l2; Lista l3;
    do{ // Programa
        do{ //Menu
            ...
            printf("\n [6] Mostra o numero de elementos da lista");
        ...
        case 6:
            {
                ...
                if (resp == 1){
                tamanho_lista(l,tam1);// Interface não é feita no TAD.
                printf("\n Tmanho da lista 1 eh: %d",tam1);
                break;
                }
                else if(resp == 2){
                tamanho_lista(l2,tam2);
                printf("\n Tmanho da lista 2 eh: %d",tam2);
                break;
                }
        ...
        case 7:
            {
                ...
                if (resp == 1){
                remove_menor(l);// Interface não é feita no TAD.
                break;
                }
                else if(resp == 2){
                remove_menor(l2);
        ...
        case 8:
            {
                //Verifica a igualdade entre as duas listas.
